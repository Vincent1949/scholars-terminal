...
sys.path.insert(0, str(PROJECT_ROOT / "research_scanner"))
...
print("🔬 Research Scanner routes registered at /api/research/*")
...
if __name__ == "__main__":
    ...
    print(f"🔬 Research API: http://localhost:8000/api/research/status\n")
