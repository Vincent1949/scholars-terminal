"""
Switch to Aerospace template for testing
"""
...
# Load Aerospace template
manager = TemplateManager()
template = manager.load_template('aerospace')

# Save as user_config
manager.save_template('user_config', template)

print("[OK] Aerospace Engineering template saved as user_config")
print()
...
print()
print("Ready to test Aerospace template!")
